...
jQuery(document).ready(function () {
    ...
    jQuery('.card-body').on('click', '.add-new-number ', function () {
        ...
        todo.ajax.call({
            url: todo.baseURL + "contactDetails/create",
            dataType: "html",
                ...
                confirm: {
                    ...
                    action: function () {
                        if(contactId !== undefined){
                            todo.ajax.call({
                                url: todo.baseURL + "contactDetails/delete/" + contactId,
                                success: function (content) {
                                    if(content.success === true){
                                        todo.messageBox.showMessage(true, content.info);
                                        _this.closest(".form-group").remove();
                                    }else{
                                        todo.messageBox.showMessage(false, content.info)
                                    }
                                }
                            });
                        }else{
