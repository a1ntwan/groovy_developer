...
class ActionDBTest extends GroovyTestCase {
    ...
    void testPlus() {
        ...
        Action testAction7 = new Action(activity: "test1", start: LocalDateTime.parse("01.01.2024 21:00", 'dd.MM.yyyy HH:mm'), duration: 3600)
    ...
    void testTestPlus() {
        ...
        Action testAction8 = new Action(activity: "test1", start: LocalDateTime.parse("01.01.2024 21:00", 'dd.MM.yyyy HH:mm'), duration: 1800)
    ...
    void testMinus() {
        ...
        Action testAction9 = new Action(activity: "test1", start: LocalDateTime.parse("01.01.2024 21:00", 'dd.MM.yyyy HH:mm'), duration: 3600)
    ...
    void testTestMinus() {
        ...
        Action testAction9 = new Action(activity: "test1", start: LocalDateTime.parse("01.01.2024 21:00", 'dd.MM.yyyy HH:mm'), duration: 1800)
