...
class HomeWork {
    static void main(String[] args) {
        ...
        def dataTemplateClient = new DataTemplateJdbc(dbExecutor, entitySQLMetaDataClient, entityClassMetaDataClient)
        ...
        def clientAfterUpdate = dbServiceClient.saveClient(clientForUpdate as Client)
